...
export function LockButton({ mobile = false }: { mobile?: boolean }) {
	...
	return (
		<button
			...
			className={
				mobile
					? "flex-1 flex flex-col items-center gap-1 py-2.5 px-1 text-muted-foreground hover:text-foreground transition-colors duration-100 disabled:opacity-40"
		...
		>
			...
			/>
			<span className={mobile ? "text-[9px] tracking-widest" : undefined}>
